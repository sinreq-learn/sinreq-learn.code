...
def eval_imagenet(net_name, param_path, shift_back, trainable=False, err_mean=None, err_stddev=None, train_vars=None, cost_factor=200., n_epoch=1):
	...
	with tf.Session() as sess:
		...
		if trainable:
			...
			image_producer = dataset.ImageNetProducer(val_path=path_val + '/val_40.txt', data_path=path_val, data_spec=data_spec)
			#image_producer = dataset.ImageNetProducer(val_path='/home/behnam/ILSVRC2012_img_val_40K/val_40.txt', data_path='/home/behnam/ILSVRC2012_img_val_40K', data_spec=data_spec)
...
acc, netparams = eval_imagenet('resnet18', param_path, shift_back, trainable=True, err_mean=None, err_stddev=None, train_vars=None, cost_factor=200., n_epoch=1)
print(acc)
...
input_file = '/home/behnam/rlbitwidth.tfmodels/caffe2tf/tfmodels/resnet18/resnet18.ckpt'
path_save = '/home/behnam/results/quantized/resnet18/resnet18'
path_save_q = path_save + '_layers_shift_quant_10May.pickle'
param_path = save_path_params
acc, netparams = eval_imagenet('resnet18', param_path, shift_back, trainable=False, err_mean=None, err_stddev=None, train_vars=None, cost_factor=0., n_epoch=1)
print(acc)
'''
...
#(res2a_branch1,1), (res3a_branch2b,1) = 84.7225
#(res2a_branch1,1), (res3a_branch2b,2) = 84.5925
#(res2a_branch1,1), (res3a_branch2b,3) = 83.68
#(res2a_branch1,1), (res3a_branch2b,2), (res3a_branch2b,1) = 84.6325
#(res2a_branch1,1), (res3a_branch2b,2), (res3a_branch2b,2) = 84.56
#(res2a_branch1,1), (res3a_branch2b,2), (res3a_branch2b,3) = 84.015
#(res2a_branch1,1), (res3a_branch2b,2), (res3a_branch2b,2), (res3b_branch2b,2) = 84.605 / 84.5375
#(res2a_branch1,1), (res3a_branch2b,2), (res3a_branch2b,2), (res3b_branch2b,3) = 84.22 
#(res2a_branch1,1), (res3a_branch2b,2), (res3a_branch2b,2), (res3b_branch2b,2) = 84.22 
# ... (res4a_branch1,2) = 84.52
